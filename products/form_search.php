<?php 
	...
	*/
	...
	echo "                        <thead>";
	echo "                            <tr>";
	echo "                                <th style = 'display:none;' tabindex='0' rowspan='1' colspan='1' width='0'>ID</th>";
	...
	echo "                                <td width'500' align='left'>".$clientes[1]."</td>";
	echo "                                <td width'200' align='left'>".$clientes[2]."</td>";
	echo "                                <td width'80' class='center'>$clientes[3]</td>";
