...
$ide = $_POST['ide'];
$sql_edit= "SELECT id, name, description, code from products where id =$ide;";
  ...
  <div class='modal-dialog'>
    <div class='modal-content'>
      <div class='modal-header'>
        ...
        <h4 class='modal-title' id='myModalLabel' align='center'>Editar Producto</h4>
      </div>
      ...
      <div class='modal-body'>
        ...
        <form class='form-horizontal well' data-async data-target='#rating-modal'>
            ...
            <div class='form-group'>
                ...
                <div class='form-group'>
                    <label for='ape_pedit' class='col-lg-2 control-label'>Descripcion</label>
                    <div class='col-lg-10'>
                        <input type='text' class='form-control' name='password_edit' id='password_edit' value='$edit_clientes[2]'>
                    </div>
                </div>
                <div class='form-group'>
                    <label for='ape_medit' class='col-lg-2 control-label'>Codigo</label>
                    <div class='col-lg-10'>
      ...
      <div class='modal-footer'>
        <button onclick='MDproducts();' type='button' class='btn-flat'>Guardar</button>
