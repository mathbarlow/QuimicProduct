...
echo "<div class='modal-dialog'>
    <div class='modal-content'>
      <div class='modal-header'>
        ...
        <h4 class='modal-title' id='myModalLabel' align='center'>Eliminar Producto</h4>
      </div>
      <div class='modal-body'>
        <form class='form-horizontal well' data-async data-target='#rating-modal' method='POST'>
            ...
            <div class='form-group'>
                    <label for='nombre' class='col-lg-2 control-label' align='center'><p align='center'>Estas seguro(a) de eliminar este producto ?</p></label>
                    
                </div>
        </form>
      </div>
      <div class='modal-footer'>
        <button id='eliminar' onclick='ECproducts();' type='button' class='btn-flat' data-dismiss='modal'>Si</button>
