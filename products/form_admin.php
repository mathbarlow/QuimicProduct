<?php 
	...
	*/
	...
	echo "                                <th tabindex='0' rowspan='1' colspan='1'>Descripcion</th>";
	echo "                                <th tabindex='0' rowspan='1' colspan='1'>Codigo</th>";
	...
	echo "                                <td class='center'><a onclick='LDEproducts(".$ide=$clientes[0].");' data-toggle='modal' data-target='#myModal-Edit' style='cursor:pointer;'><i class='glyphicon glyphicon-pencil'></i></a></td>";
	echo "                                <td class='center'><a onclick='MEproducts(".$ide=$clientes[0].");' data-toggle='modal' data-target='#myModal-Delete' style='cursor:pointer;'><i class='glyphicon glyphicon-remove'></i></a></td>";
	echo "                            </tr>";
			}
	echo "                        </tbody>";
	echo "                    </table>";
